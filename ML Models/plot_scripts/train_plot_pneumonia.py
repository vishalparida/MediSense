...
def main():
    ...
    parser.add_argument('--data_dir', required=True, help='Path to dataset folder (contains "NORMAL" and "PNEUMONIA" subfolders)')
    ...
    save_accuracy_plot(history.history, args.out_dir, prefix='pneumonia_')
    save_loss_plot(history.history, args.out_dir, prefix='pneumonia_')
    save_history_json(history.history, os.path.join(args.out_dir, 'pneumonia_history.json'))
    model.save(os.path.join(args.out_dir, 'pneumonia_model.h5'))
