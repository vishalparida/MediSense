      ...
      <div className="p-4 border-b border-border">
        ...
        <div className="relative mb-4">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm bg-background text-foreground"
            aria-label="Search patients"
          />
        </div>

        {/* View Mode Tabs */}
        <div className="flex space-x-1 mb-4 bg-secondary rounded-lg p-1">
          <button
        ...
        <div className="grid grid-cols-2 gap-2 mb-4">
          <Select value={statusFilter} onValueChange={setStatusFilter}>
            ...
            <SelectContent>
              ...
              <SelectItem value="awaiting_doctor">
                Awaiting ({getStatusCount("awaiting_doctor")})
              </SelectItem>
              <SelectItem value="video_scheduled">
                Video ({getStatusCount("video_scheduled")})
              </SelectItem>
